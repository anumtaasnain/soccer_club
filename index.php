   ...
   <div class="col-md-6 col-sm-6 col-xs-12">
      <div class="row">
         <div class="full">
            <div class="matchs-vs">
               <div class="vs-Player">
                  <div class="Player-btw-match">
                     <ul>
                        <li>
                           <img src="images/img-03.png" alt="">
                           <span>Footbal Player</span>
                        </li>
                        <li class="vs"><span>vs</span></li>
                        <li>
                           <img src="images/img-04.png" alt="">
                           <span>Super Player Club</span>
                        </li>
                     </ul>
                  </div>
               </div>
...
<div class="Player-holder theme-padding">
   <div class="container">
      <div class="main-heading-holder">
         <div class="main-heading sytle-2">
            <h2>Meet Our Player</h2>
            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium<br>doloremque laudantium, totam rem aperiam</p>
         </div>
      </div>
      <div id="Player-slider">
         <div class="container">
           <div class="row">
            <?php
            $select = "SELECT * FROM players INNER JOIN teams on players.PlayerID = teams.teamID ";
            $result = mysqli_query($conn, $select);
            while ($row = mysqli_fetch_array($result)) {
            ?>
               <div class="col-md-3">
                  <div class="Player-column style-2">
                     <img src="../admin/player/<?php echo $row['PlayerImageURL'] ?>" height="400px" width="100%" alt="">
                     <div class="player-name">
                        <div class="desination-2"><?php echo $row['PlayerName'] ?></div>
                        <h5><?php echo $row['teamName'] ?></h5>
                        <span class="player-number"><?php echo $row['JerseyNumber'] ?></span>
                     </div>
                  </div>
               </div>
            <?php } ?>
